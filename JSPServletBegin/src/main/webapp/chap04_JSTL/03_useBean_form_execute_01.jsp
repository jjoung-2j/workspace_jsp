...
<link rel="stylesheet" type="text/css" href="<%= ctxPath%>/chap04_JSTL/css/03.css">
<%-- 안전빵으로 상대경로보다는 절대경로로 작성하는 것이 좋다. servlet 파일로 실행시에도 css 적용할 수 있도록 --%>
<script type="text/javascript" src="<%= ctxPath%>/js/jquery-3.7.1.min.js"></script>
<script type="text/javascript" src="<%= ctxPath%>/chap04_JSTL/js/03.js"></script>
</head>
<body>
	<div id="container">
		...
		<form name="registerFrm" action="<%= ctxPath%>/registerPerson2.do" method="post">
			...
			<fieldset>
            <legend>개인성향 테스트 2 (JSTL 사용한 것)</legend>
            <ul>
            <li>
