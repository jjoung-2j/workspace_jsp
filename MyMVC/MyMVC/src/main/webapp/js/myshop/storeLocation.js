$(document).ready(function() { 
    ...
    // 지도를 생성할때 필요한 기본 옵션
    var options = {
        center: new kakao.maps.LatLng(37.556513150417395, 126.91951995383943), // 지도의 중심좌표. 반드시 존재해야함. // 지도의 가운데가 어디냐~~
        /*
    ...
    $.ajax({
        url:"storeLocationJSON.up",     // <%= ctxPath%>/shop/storeLocationJSON.up
