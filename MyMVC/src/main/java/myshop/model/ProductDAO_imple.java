	...
	public List<SpecVO> selectSpecList() throws SQLException {
	    ...
	    try {
	        ...
	        while(rs.next()) {
	        	...
	        	spec.setSnum(rs.getInt(1));
	        	spec.setSname(rs.getString(2));
...
////////////////////////////////////////////////////////////////////
	...
	// 제품번호를 가지고서 해당 제품의 제품설명서 첨부파일의 서버에 업로드 되어진 파일명과 오리지널파일명 알아오기
	@Override
...
////////////////////////////////////////////////////////////////////
	...
	// === 장바구니 수량 수정 === //
	@Override
	public int updateoqty(Map<String, String> paraMap) throws SQLException {
	...
	}	// end of public int updateoqty(Map<String, String> paraMap) throws SQLException {----------
...
///////////////////////////////////////////////////////////////////////////////////////////
		    ...
		    // 5. 장바구니 테이블에서 str_cartno_join 값에 해당하는 행들을 삭제(delete)하기(수동커밋처리)
			// >> 장바구니에서 주문을 한 것이 아니라 특정제품을 바로주문하기를 한 경우에는 장바구니 테이블에서 행들을 삭제할 작업은 없다. <<
			if(n3==1 && paraMap.get("cartno_arr") != null) {	// paraMap.get("cartno_arr") != null => 장바구니를 통해 주문한 경우
			...
			if(n3==1 && paraMap.get("cartno_arr") == null) {	// paraMap.get("cartno_arr") != null => 바로 주문한 경우
...
/////////////////////////////////////////////////////////////////////////////
	...
	}	// end of public List<ProductVO> getJumunProductList() throws SQLException--------
	...
	public List<Map<String, String>> getOrderList(Map<String, String> paraMap) throws SQLException {
		...
		try {
	        ...
	        if(!"admin".equals(paraMap.get("userid"))) {	// 관리자가 아닌 일반사용자로 로그인 한 경우 
	        ...
	        */
			...
			if(!"admin".equals(paraMap.get("userid"))) {	// 관리자가 아닌 일반 사용자로 로그인 한 경우
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	}	// end of public List<Map<String, String>> myPurchase_byCategory(String userid)--------------
