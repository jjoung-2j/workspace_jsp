...
$(document).ready(function(){
    ...
    $("input#name").blur(e => {
        ...
        if(name == ""){     // 입력하지 않거나 공백만 입력했을 경우
            ...
            $("table#tblMemberEdit :input").prop('disabled',true);  // 아무것도 작성하지 않고 포커스 잃을 때만 비활성화 된다. 하나라도 작성할 시 비활성화 되지 않는다.
            // 모든 input 태그 비활성화
        /*   
            >>>> .prop() 와 .attr() 의 차이 <<<<            
   ...
   $("img#zipcodeSearch").click(function(){
    ...
    $("span#emailcheck").click(function(){
        ...
        $.ajax({
            ...
            url: "editEmailDuplicateCheck.up"
            ...
            , dataType : "json"     // 주의. dataType 의 T 는 대문자!! / 데이터 타입을 String 에서 json 형식으로 바꾼다. json 형식으로 주지않으면 오류 발생
            ...
            , success: function(json){  // text 글자는 임의로 작성한 것 ( text 자리는 이름 상관없음 )
